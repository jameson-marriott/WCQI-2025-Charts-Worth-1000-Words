...
Once you have those installed, the easiest way to run the code will be do download the quarto file from github and open it with RStudio. From there you can easily run code chunks or the entire file. Again, there are a lot of resources on how to do this, but this page might be a good place to start: <https://quarto.org/docs/get-started/hello/rstudio.html>.
